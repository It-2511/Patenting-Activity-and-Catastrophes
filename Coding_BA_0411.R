...
fips_data_population_and_gdp <- fips_data_population_and_gdp %>%
  mutate(across(c(PropertyDmg, PropertyDmgPerCapita, Patentcounts, `Log-PropertyDmg`, `Log-PropertyDmgPerCapita`, PropertyDmg_per_GDP, PropertyDmgPerCapita_corrected, Log_PropertyDmgPerCapita_manual), ~replace_na(., 0)))
